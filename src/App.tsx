              ...
              <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8"> {/* Adicionando padding responsivo */}
                <div className="grid md:grid-cols-2 gap-12">
                  <div className="text-white">
                    ...
                    <h1 className="text-[30px] sm:text-[36px] md:text-[52px] font-bold leading-tight mb-4">
                      A sua obra entregue no prazo, <span className="inline">e com</span> <br className="hidden md:inline" />
                      qualidade garantida
                    </h1>
